class FilePaths:
    ...
    def _set_output_file_paths(self, months, function):
        ...
        self.observed_daily_discharge_FDCs = f"{self.results}Arolla_15min_FDCs_from_observed_daily_discharge.csv"
        self.simulated_daily_discharge_FDCs = f"{self.results}Arolla_15min_FDCs_from_hydrobricks_daily_discharge.csv"
        self.weather_observed_daily_discharge_FDCs = f"{self.results}Arolla_15min_FDCs_from_observed_daily_discharge_plus_weather.csv"
        self.multi_weather_observed_daily_discharge_FDCs = f"{self.results}Arolla_15min_FDCs_from_observed_daily_discharge_plus_weather_plus_multiregr.csv"
